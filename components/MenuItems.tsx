        ...
        <div className="flex-1 min-w-0">
          <div className="flex justify-between items-start gap-2">
            <div className="flex-1">
              ...
              <p className="text-xs sm:text-sm text-gray-400 mt-0.5 line-clamp-2">{product.description}</p>
            </div>
            <span className="text-rose-500 font-bold text-base sm:text-lg whitespace-nowrap flex-shrink-0 ml-2">
