...
- Tailwind CSS
- Design system editoriale (Archivo Black, DM Mono)

## Funzionalità

- Menu digitale con card piatti, immagini a piena larghezza
- Carrello e checkout demo (nessuna integrazione di pagamento reale attiva)
- QR code per accesso diretto al tavolo
